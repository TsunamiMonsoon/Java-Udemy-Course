...
//
// If the parameter are valid the calculate how many centimeters
...
// 1 inch = 2.45 cm and one foot = 12 inches
...
public class Main {
    public static void main(String[] args) {
        int newScore = calculateScore("Eggs", 500);
    ...
    public static double calcFeetAndInchesToCentimeters (double feet, double inches) {
        ...
        double centimeters  = (feet * 12) * 2.45;
